  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="liquid-glass rounded-[18px] border border-white/15 shadow-[0_8px_32px_rgba(0,0,0,0.35),inset_0_0.5px_0_rgba(255,255,255,0.1)] fixed right-2 bottom-[64px] z-50 w-[280px] origin-bottom-right p-4"
      >
        {/* Month header */}
