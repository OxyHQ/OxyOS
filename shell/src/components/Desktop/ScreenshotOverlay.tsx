...
function Toast({ message, onDone }: { message: string; onDone: () => void }) {
  ...
  return (
    <motion.div
      className="fixed bottom-6 right-6 z-[9999] px-4 py-2 text-sm font-medium text-white liquid-glass rounded-[14px] border border-white/15 shadow-[0_8px_32px_rgba(0,0,0,0.35),inset_0_0.5px_0_rgba(255,255,255,0.1)]"
        ...
        {isActive && (
          ...
          >
            <div className="flex h-full w-full items-center justify-center">
              <motion.div
                className="px-5 py-2.5 text-sm font-medium text-white liquid-glass rounded-[14px] border border-white/15 shadow-[0_8px_32px_rgba(0,0,0,0.35),inset_0_0.5px_0_rgba(255,255,255,0.1)]"
