  ...
  return (
    <>
      ...
      <div className="fixed right-0 bottom-0 left-0 z-40 grid h-[48px] grid-cols-[48px_1fr_auto] items-center rounded-t-2xl bg-[rgba(32,33,36,0.82)] px-1 backdrop-blur-[60px] backdrop-saturate-[180%]">
        ...
        {/* Right: System tray */}
        <button
          className="mr-1 flex h-[36px] cursor-pointer items-center gap-2 rounded-full px-3 transition-colors duration-150 hover:bg-white/10"
          onClick={toggleQuickSettings}
          aria-label="System tray"
        >
          <span className="text-[11px] font-medium text-white/90">{shortDate}</span>
