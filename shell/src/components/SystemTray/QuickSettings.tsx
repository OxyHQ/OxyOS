  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed bottom-[64px] right-2 z-50 w-[360px] origin-bottom-right rounded-[20px] border border-white/20 bg-white/12 p-0 shadow-[0_8px_40px_rgba(0,0,0,0.35),inset_0_0.5px_0_rgba(255,255,255,0.15)] backdrop-blur-[60px] backdrop-saturate-[180%]"
      >
        {/* Toggle pills grid */}
        <div className="grid grid-cols-2 gap-2 p-4 pb-3">
          ...
          {/* Bluetooth */}
          <button className="flex items-center gap-3 rounded-2xl bg-white/8 px-4 py-3.5 text-left text-white/70 transition-colors duration-150 hover:bg-white/12">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="shrink-0">
        ...
        <div className="border-t border-white/10 px-5 pt-4 pb-3">
          ...
          <div className="mb-3 flex items-center gap-4">
            ...
            <input
              ...
              className="h-2 flex-1 cursor-pointer appearance-none rounded-full outline-none [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-[#0a84ff] [&::-moz-range-thumb]:bg-white [&::-moz-range-thumb]:shadow-[0_1px_3px_rgba(0,0,0,0.3)] [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-[#0a84ff] [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:shadow-[0_1px_3px_rgba(0,0,0,0.3)]"
          ...
          <div className="flex items-center gap-4">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="white" fillOpacity="0.5" className="shrink-0">
