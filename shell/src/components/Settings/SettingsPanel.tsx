      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="liquid-glass rounded-[18px] border border-white/15 shadow-[0_8px_32px_rgba(0,0,0,0.35),inset_0_0.5px_0_rgba(255,255,255,0.1)] fixed top-1/2 left-1/2 z-50 flex h-[500px] w-[700px] -translate-x-1/2 -translate-y-1/2 overflow-hidden"
          >
            {/* Sidebar */}
