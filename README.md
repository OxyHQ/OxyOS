...
In 2015, Philip Newborough (Corenominal) officially discontinued CrunchBang. This project carries that design philosophy forward while adapting for current Debian tooling and dependencies.
...
Some legacy internal names (for example `cbpp` in package/service identifiers) are still present in build internals and will be migrated incrementally to avoid breaking image build behavior.
...
- [OxyOS-website](https://github.com/OxyOS/OxyOS-website) - Source code for the website available at https://os.oxy.so/ (CSS, WTFPL, updated Oct 29, 2025)
- [OxyOS-menu](https://github.com/OxyOS/OxyOS-menu) - Menu tooling for OxyOS (Python, updated Aug 22, 2025)
- [OxyOS-apps](https://github.com/OxyOS/OxyOS-apps) - OxyOS apps package sources (Python, MIT License, updated Aug 22, 2025)
- [OxyOS-welcome](https://github.com/OxyOS/OxyOS-welcome) - Optional post-installation script for OxyOS (Shell, updated Aug 22, 2025)
- [OxyOS-wallpapers](https://github.com/OxyOS/OxyOS-wallpapers) - A selection of wallpapers (updated Aug 22, 2025)
- [OxyOS-ui-theme](https://github.com/OxyOS/OxyOS-ui-theme) - OxyOS user interface theme assets (CSS, updated Aug 22, 2025)
- [OxyOS-pipemenus](https://github.com/OxyOS/OxyOS-pipemenus) - Openbox pipemenus for OxyOS (Shell, updated Aug 22, 2025)
- [OxyOS-metapackage](https://github.com/OxyOS/OxyOS-metapackage) - Basic metapackage for OxyOS (updated Aug 22, 2025)
- [OxyOS-lxdm-theme](https://github.com/OxyOS/OxyOS-lxdm-theme) - OxyOS LXDM theme resources (CSS, updated Aug 22, 2025)
- [OxyOS-icon-theme](https://github.com/OxyOS/OxyOS-icon-theme) - Default icon themes for OxyOS (updated Aug 22, 2025)
- [OxyOS-exit](https://github.com/OxyOS/OxyOS-exit) - Script prompt for system power-state options (Python, updated Aug 22, 2025)
- [OxyOS-configs](https://github.com/OxyOS/OxyOS-configs) - Various configuration files for use with OxyOS (Shell, updated Aug 22, 2025)
